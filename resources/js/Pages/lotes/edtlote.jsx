...
const edtlote = ({ busca, lote }) => {
    ...
    const saveData = (e) => {
        ...
        Inertia.post(route('lotes.update', loteUpdate.id_lote), { _method: 'put', data_lote, lote, femea, macho })
    }

    useEffect(() => {
        loteRef.current.value = loteUpdate.lote;
        femeaRef.current.value = loteUpdate.femea;
        machoRef.current.value = loteUpdate.macho;
    }, [])
    return (
        <Fragment>
            <Template>
                <div className="container m-auto bg-gray-50 my-4 shadow-sm border-2 border-white rounded-md">
                    ...
                    <form onSubmit={saveData} autoComplete="off">
                        <div className="md:w-1/2 md:mx-auto bg-white md:my-20 p-6 m-4 rounded-md shadow-md border border-gray-100">
                            <div className="pt-2">
                                <label className="text-gray-700 dark:text-gray-200" htmlFor="data">Data de Entrada do Lote</label>
                                <DatePicker
                                    selected={startDate}
                            ...
                            <div className="pt-2">
                                <label className="text-gray-700 dark:text-gray-200" htmlFor="lote">Identificação do Lote</label>
                                <input
                                    ref={loteRef}
                                    id="lote"
                                    type="text"
                            ...
                            <div className="pt-2">
                                <label className="text-gray-700 dark:text-gray-200" htmlFor="femea">Aves Fêmeas</label>
                                <input
                                    ref={femeaRef}
                                    id="femeas"
                                    type="number"
                            ...
                            <div className="pt-2">
                                <label className="text-gray-700 dark:text-gray-200" htmlFor="macho">Aves Machos</label>
                                <input
                                    ref={machoRef}
                                    id="macho"
                                    type="number"
