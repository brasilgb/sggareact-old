...
Route::prefix('lotes')->name('lotes.')->group(function () {
    ...
    Route::get('capitalizar/{lote}', [LoteController::class, 'capitalizar'])->name('capitalizar');
...
Route::prefix('usuarios')->name('usuarios.')->group(function () {
    Route::post('busca', [UsuarioController::class, 'busca'])->name('busca');
    Route::post('autocomplete', [UsuarioController::class, 'autocomplete'])->name('autocomplete');
});
